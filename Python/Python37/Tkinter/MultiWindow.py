...
class MyChildFrame(tkinter.Toplevel):
    def __init__(self, parent, title=None, modal=True) -> None:
    ...
    def initWidgets(self):
        self.button1 = tkinter.Button(self, text="First Window")
        self.button1.pack(side=tkinter.LEFT)
        self.button2 = tkinter.Button(self, text="Second Window")
...
class MainWindow:
    ...
    def button1_command(self):
        if (self.win_flag1.get() == 0):
            ...
            next_win=MyChildFrame(self.root, "First Window")
    ...
    def button2_command(self):
        if (self.win_flag2.get() == 0):
            ...
            next_win=MyChildFrame(self.root, "Second Window", modal=False)
